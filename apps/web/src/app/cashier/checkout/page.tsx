...
import { buildBusinessReceiptHtml, formatReceiptLine, printReceiptHtml, printReceiptText, separatorLine } from '@/lib/receiptPrinter';
...
export default function CheckoutPage() {
  ...
  const printAndCloseReceipt = async () => {
    ...
    const rawLines: string[] = [
      companyProfile?.name || 'Billiard Club OS',
      companyProfile?.address || '',
      companyProfile?.phoneNumber ? `Telp: ${companyProfile.phoneNumber}` : '',
      separatorLine(),

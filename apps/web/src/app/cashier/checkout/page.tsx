...
export default function CheckoutPage() {
  ...
  const selectableOrders = sessionOrders;
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 p-6">
      ...
      <div className="card">
        ...
        {selectedSession && selectableOrders.length > 0 && (
          <div className="mb-4">
            <label className="label">Pesanan F&B (terikat sesi)</label>
      ...
      {currentReceipt && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl bg-white p-4">
            <div className="mb-2 text-center"><h3 className="text-lg font-bold">Pembayaran Berhasil</h3><p className="text-xs text-slate-500">{currentReceipt.paymentNumber}</p></div>
            ...
            <button className="btn-primary mt-4 w-full" onClick={() => setCurrentReceipt(null)}>Tutup</button>
          </div>
        </div>
      )}
    </div>

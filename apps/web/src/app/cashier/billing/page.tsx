                      ...
                      <td>
                        <div className="flex flex-wrap gap-2">
                          {isOwner ? (
                            ...
                            <>
                              <a href={`/cashier/orders?sessionId=${s.id}`} className="rounded-lg bg-blue-100 px-2 py-1 text-xs text-blue-700 hover:bg-blue-200">Pesan F&B</a>
                              <button onClick={() => openDetailModal(s)} className="rounded-lg bg-indigo-100 px-2 py-1 text-xs text-indigo-700 hover:bg-indigo-200">Lihat Detail</button>
                            </>
                          ) : (
                            <>
                              {(s.payments || []).length === 0 && (

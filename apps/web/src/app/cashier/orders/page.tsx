      ...
      {showCheckoutModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 p-4">
          <div className="w-full max-w-lg rounded-xl bg-white p-5">
            ...
            <input type="number" className="input mb-2" placeholder="Uang diterima" value={amountPaid} onChange={(e) => setAmountPaid(e.target.value)} />
            {method === 'CASH' && (
      ...
      {receipt && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-md rounded-xl bg-white p-4">
            <div className="mb-2 text-center"><h3 className="text-lg font-bold">Pembayaran Berhasil</h3><p className="text-xs text-slate-500">{receipt.paymentNumber}</p></div>

...
const navByRole: Record<string, NavItem[]> = {
  ...
  OWNER: [
    ...
    { label: 'Manajemen Menu', href: '/owner/menu', icon: <MenuIcon /> },
    { label: 'Manajemen Kategori', href: '/owner/menu-categories', icon: <TagIcon /> },
    { label: 'Manajemen Paket', href: '/owner/packages', icon: <TagIcon /> },
    { label: 'Manajemen Aset', href: '/owner/stock', icon: <BoxIcon /> },
  ...
  MANAGER: [
    ...
    { label: 'Manajemen Paket', href: '/manager/packages', icon: <TagIcon /> },
